...
func (q *Queries) RevokeRefreshTokenByToken(ctx context.Context, arg RevokeRefreshTokenByTokenParams) error {
	_, err := q.db.ExecContext(ctx, revokeRefreshTokenByToken, arg.Token, arg.RevokedAt)
	return err
}
